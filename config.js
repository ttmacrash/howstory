...
window.HOWSTORY_STAY = {
  ...
  // 요금(원, 2인 기준). 에어비앤비 2박 총액을 1박으로 환산한 값이라 요금이 바뀌면 여기만 고치세요. PRICE_FROM을 null로 두면 "요금은 에어비앤비에서 확인"으로만 표시
  PRICE_FROM: 211200,          // 주중(일~목) 1박 할인가 — 10/5~7 2박 ₩422,400 ÷ 2
  PRICE_LIST: 264000,          // 주중 1박 정가 — ₩528,000 ÷ 2 (취소선으로 표시, null이면 숨김)
  PRICE_WEEKEND: 279200,       // 금·토 1박 할인가 — 10/2~4 2박 ₩558,400 ÷ 2 (null이면 숨김)
  PRICE_WEEKEND_LIST: 349000   // 금·토 1박 정가 — ₩698,000 ÷ 2
};
